export const CardProjects = async () => {
  const datos = await fetch(
    "http://localhost:8080/api/v1/startups/Startups/"
...
//                 style={{
//                   width: `${
//                     (projecto.montoAcumulado / projecto.valor_recaudar) * 100
//                   }%`,
//                 }}
//               ></div>
//             </div>
...
//             Meta:{" "}
//             <span className="text-green-600">{projecto.valor_recaudar}</span>
//           </div>
